    ...
    public partial class Mig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VerifcationCodes", x => new { x.Code, x.UserId });
                    table.ForeignKey(
                        name: "FK_VerifcationCodes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VerifcationCodes_UserId",
                table: "VerifcationCodes",
                column: "UserId",
                unique: true);
        }
